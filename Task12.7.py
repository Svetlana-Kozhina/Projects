...
print(deposit) # Список значений - накопленные средства за год вклада в каждом из банков без сортировки

deposit.sort()

print(deposit) # Список значений - накопленные средства за год вклада в каждом из банков со сортировкой

print(f'Максимальная сумма, которую вы можете заработать - {deposit[-1]}')
